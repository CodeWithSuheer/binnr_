...
const How = () => {
  return (
    <>
      <section className="relative px-4 xl:px-0 py-1">
        <div className="max-w-5xl xl:max-w-6xl xxl:max-w-7xl mx-auto ">
          <div className="grid grid-cols-1 gap-y-2 lg:gap-3 xl:gap-0 lg:grid-cols-2">
            <div className="left_side flex justify-center lg:justify-start items-end sm:items-center min-w-[50%]">
              <div className="content px-0 sm:px-4 md:px-6 py-0 sm:py-8">
                ...
                <p className="mt-2 font-gotham max-w-md text-sm text-gray-900 sm:text-[1.05rem] tracking-wide">
          ...
          <div className="grid grid-cols-1 gap-y-2 lg:gap-3 xl:gap-0 lg:grid-cols-2">
            ...
            <div className="left_side flex justify-center lg:justify-start items-end sm:items-center min-w-[50%]">
              <div className="content px-0 sm:px-4 md:px-6 py-0 sm:py-8">
                ...
                <p className="font-gotham mt-2 max-w-md text-sm text-gray-900 sm:text-[1.05rem] tracking-wide">
